...
export default function BusinessImmigrationPageComponent({ value }: { value: any }) {
  ...
  const steps = (data?.howItWorks ?? []).slice().sort((a, b) => a.stepNumber - b.stepNumber);
  const left = steps.filter(s => s.stepNumber % 2 === 1);
  const right = steps.filter(s => s.stepNumber % 2 === 0);
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <ul className="space-y-1">
                            {fee.details.map((detail: any, detailIndex: number) => (
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="border-t pt-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {stream?.streams?.map((streamName: any, streamIndex: number) => (
