  ...
  const navItems = [
    ...
    { name: "About", href: "/about" },
    {
      ...
      dropdown: [
        ...
        { name: "Work Permits", href: "/services/study-work-permits" },
        { name: "Family Sponsorship", href: "/services/family-sponsorship" },
        { name: "Visitor Visa", href: "/services/visitors-visa" },
        { name: "Citizenship & Integration", href: "/services/visitors-visa" },
        { name: "Refugee/Asylum Visa", href: "/services/visitors-visa" },
      ],
    },
